        ...
        [
            ...
            *(
            ...
            dcc.Interval(
                ...
                interval=BaseConfig.qmt_check_interval * 1000, # 毫秒
                n_intervals=0
            ),
            ...
            fac.AntdModal(
                ...
                children=[
                    fac.AntdSpace(
                        [
                            fac.AntdText("QMT连接管理", strong=True),
                            fac.AntdText("如果遇到行情不更新或交易指令无响应，请尝试手动重连。", type="secondary"),
                            fac.AntdButton(
                                "手动重新连接", 
                            ...
                            fac.AntdDivider(),
                            fac.AntdText("基础数据维护", strong=True),
                            fac.AntdText("更新股票、ETF、可转债的代码与名称映射表。", type="secondary"),
                            fac.AntdButton(
                                "更新证券代码表", 
