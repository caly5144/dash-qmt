...
from .settings import GLOBAL_SECRETS
...
class BaseConfig:
    ...
    # QMT 连接状态检查间隔（秒）
    qmt_check_interval: int = 300

    # 应用基础标题
    app_title: str = "Dash Qmt"

    # 应用版本
    app_version: str = "0.0.1"

    # 应用密钥
    app_secret_key: str = GLOBAL_SECRETS.get("APP_SECRET_KEY", "magic-dash-pro-demo")
